# Contributing to @tan-yong-sheng/code-context-mcp
...
```bash
claude mcp add code-context -e OPENAI_API_KEY=sk-your-openai-api-key -- node PATH_TO_CLAUDECONTEXT/packages/mcp/dist/index.js
```
