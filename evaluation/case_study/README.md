...
This directory includes some case analysis. We compare the both method(grep + Code Context semantic search) and the traditional grep only method.
...
## Key Results
Compared with traditional grep only, the both method(grep + Code Context semantic search) is more efficient and accurate.
